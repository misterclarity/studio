...
import { updateExhibitItemAction } from "@/lib/actions";
...
export function MetadataDisplay({ itemId, initialMetadata }: { itemId: string; initialMetadata: ExhibitMetadata }) {
    ...
    const handleSave = async () => {
        if (editingKey) {
            ...
            await updateExhibitItemAction(itemId, { metadata: updatedMetadata });
            setEditingKey(null);
        }
    };
